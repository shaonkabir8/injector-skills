#!/usr/bin/env node
// Tests for src/mcp-servers/injector-skills-shrink/compress.js — pure-Node prose compressor.
...
const { compress, compressDescriptionsInPlace } = require(
  path.join(ROOT, 'src', 'mcp-servers', 'injector-skills-shrink', 'compress.js')
);
